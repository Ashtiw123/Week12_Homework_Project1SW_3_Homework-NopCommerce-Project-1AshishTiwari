...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_FirstName']"), "Ash");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_LastName']"), "Ast");
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Email']"), "AT@Gmail.com");
       ...
       // Thread.sleep(3000);
        ...
        sendTextToElement(By.xpath("//input[@id='CardholderName']"), "MR TTAA");
